...
import AvatarTitles from "src/components/AvatarTitles";
    ...
    <>
      <div dir="ltr" className="bg-darkBackground">
        ...
        <div className="bg-darkBackground relative">
          <div className="flex items-center flex-col pt-5 2xl:ml-[135px] sm:pt-[20px] pl-[200px] xl:pl-[70px] lg:p-[50px] md:p-[60px] sm:p-[35px] bg-darkBackground">
            <img
            ...
            <div className="flex absolute container items-center justify-center">
              <AvatarTitles
                className={
                  "absolute group/item mt-[930px] w-40 h-40 ml-[150px] xl:ml-[50px] lg:mr-[600px] 2xl:ml-[500px] lg:mt-[100px] md:mt-[240px] md:ml-[150px] sm:mt-[50px] sm:mr-[60px] animate-fade sm1:mt-[170px]"
                }
              ...
              <AvatarTitles
                className={
                  "absolute group/item mt-[540px] w-40 h-40 ml-[400px] 2xl:ml-[280px] lg:mb-[120px] lg:ml-[350px] md:mr-[420px] md:mt-[580px] sm:mt-[160px] sm:mr-[490px] animate-fade"
                }
                avatarImage={"/assets/images/avatar-in-map2.png"}
              ...
              <AvatarTitles
                className={
                  "absolute group/item mt-[580px] w-40 h-40 ml-[20px] lg:ml-[30px] 2xl:ml-[900px] lg:mt-[130px] md:mr-[50px] md:mt-[300px] animate-fade sm:mt-[90px] sm:mr-[20px] sm1:ml-20 sm1:mt-[110px]"
                }
              ...
              <AvatarTitles
                className={
                  "absolute group/item mt-[400px] w-40 h-40 ml-[800px] 2xl:ml-[1200px] lg:ml-[670px] lg:mt-[300px] md:mr-[400px] md:mb-[200px] animate-jump-in animate-ease-linear sm:mt-10 sm:mr-[880px]"
                }
            ...
            <div className="mt-[440px] left-0 absolute md:w-[115px] sm:hidden md:mt-[300px] sm:mt-[90px] sm:w-[80px] ">
              <img
                className="w-[200px]"
